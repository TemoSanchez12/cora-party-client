...
const OrderConfirmationCustomerTemplate = ({
  ...
  orderSpecs,
  senderEmail,
}: OrderConfirmationCustomerTemplateProps) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <div>
        <p>
          Para cualquier duda o aclaracion comunicarse{' '}
          <span style={{ fontWeight: '800' }}>4921443840</span>
        </p>
      </div>
...
export default OrderConfirmationCustomerTemplate
